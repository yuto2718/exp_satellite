...
class BME280:
        ...
        def __setup():
                ...
                __writeReg(0xF2,ctrl_hum_reg)
                __writeReg(0xF4,ctrl_meas_reg)
                __writeReg(0xF5,config_reg)
